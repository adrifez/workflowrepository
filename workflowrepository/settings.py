...
SECRET_KEY = '_6&kjdaqv01b1zgo=s5!%z0z3(6czy^obm)h8r)lm*m_myamn_'
...
if os.getenv('SQLITE', False):
    ...
    DATABASES = {
        'default': dj_database_url.config(default = 'postgres://alumnodb:alumnodb@localhost:5432/workflowrepository')
    }
